...
export function DeleteCategoryModal({ category, onClose, onDeleted }: DeleteCategoryModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-sm rounded shadow-2xl border border-stone-100 p-8 text-center">
                ...
                <h3 className="text-lg font-serif text-stone-900 mb-2">Delete Category</h3>
                <p className="text-sm text-stone-500 mb-1">Are you sure you want to delete</p>
                <p className="text-sm font-bold text-stone-900 mb-4">&ldquo;{category.name}&rdquo;?</p>
                <p className="text-xs text-stone-400 mb-6">This action cannot be undone. Products in this category will need to be reassigned.</p>
